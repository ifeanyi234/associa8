...
$statement = mysqli_prepare($conn, 'INSERT INTO admissions (application_number, applicant_name, email, phone, guarantor_name, guarantor_email, guarantor_phone, guarantor_relationship) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
if (!$statement) {
...
mysqli_stmt_bind_param($statement, 'ssssssss', $number, $name, $email, $phone, $guarantorName, $guarantorEmail, $guarantorPhone, $guarantorRelationship);
