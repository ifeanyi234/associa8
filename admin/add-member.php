...
<div>
<h2 class="page-title-main">Create Member</h2>
<p class="page-subtitle">Add a member and assign a title and zone.</p>
</div>
<a href="member-directory.php" class="btn-outline-primary">
...
<input class="form-control" id="firstName" name="first_name" required />
</div>
<div class="form-group">
<label for="lastName" class="form-label">Last name</label>
<input class="form-control" id="lastName" name="last_name" required />
</div>
</div>
              <div class="form-row-2col">
<div class="form-group">
...
<input class="form-control" type="date" id="joinedDate" name="joined_date" value="<?php echo date('Y-m-d'); ?>" required />
</div>
</div>
              <div class="form-row-2col">
<div class="form-group">
<label for="titleId" class="form-label">Membership title</label>
<select class="form-select" id="titleId" name="title_id" required>
<option value="" selected disabled>Select title</option>
<?php if ($titlesResult): ?>
<?php while ($title = mysqli_fetch_assoc($titlesResult)): ?>
<option value="<?php echo (int) $title['id']; ?>">L<?php echo (int) $title['level']; ?> - <?php echo htmlspecialchars($title['title']); ?>
</option>
<?php endwhile; ?>
<?php endif; ?>
</select>
...
<?php if ($zonesResult): ?>
<?php while ($zone = mysqli_fetch_assoc($zonesResult)): ?>
